...
enum Opcodes
{
    ...
    //Used on SkyFire but not difined
    SMSG_LFG_BOOT_PROPOSAL_UPDATE                    = 0x00,
    CMSG_AUTOSTORE_LOOT_CURRENCY                     = 0x00, //HandleAutostoreLootItemOpcode
    SMSG_REFORGE_OPEN_FROM_GOSSIP                    = 0x00,
    SMSG_GUILD_PARTY_STATE_UPDATE                    = 0x00, //Group::SendGuildGroupStateUpdate
    SMSG_GUILD_ACHIEVEMENT_EARNED                    = 0x00, //GuildAchievementMgr::SendAchievementEarned
    SMSG_GUILD_ACHIEVEMENT_DATA                      = 0x00, //GuildAchievementMgr::SendAllAchievementData
    SMSG_GUILD_CRITERIA_DATA                         = 0x00, //GuildAchievementMgr::SendAllAchievementData
    SMSG_GUILD_CRITERIA_DELETED                      = 0x00, //AchievementMgrBase::RemoveCriteriaProgress
};
